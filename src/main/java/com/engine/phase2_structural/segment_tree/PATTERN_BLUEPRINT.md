# Pattern Blueprint: Segment Tree

## 1. System Design Mapping
* **Macro System Component:** Telemetry Metric Range Query Engine
...
1. **[Easy]** Problem 1 for Segment Tree - [🛑 Todo]
2. **[Easy]** Problem 2 for Segment Tree - [🛑 Todo]

### Phase 2: Medium System Integration
3. **[Medium]** Problem 3 for Segment Tree - [🛑 Todo]
4. **[Medium]** Problem 4 for Segment Tree - [🛑 Todo]
5. **[Medium]** Problem 5 for Segment Tree - [🛑 Todo]
6. **[Medium]** Problem 6 for Segment Tree - [🛑 Todo]
7. **[Medium]** Problem 7 for Segment Tree - [🛑 Todo]

### Phase 3: Hard Scale & Stress
8. **[Hard]** Problem 8 for Segment Tree - [🛑 Todo]
9. **[Hard]** Problem 9 for Segment Tree - [🛑 Todo]
